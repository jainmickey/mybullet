# -*- coding: utf-8 -*-
"""Django settings for mybullet project.
...
APPS_DIR = ROOT_DIR.path('mybullet')
...
ADMINS = getaddresses([env("DJANGO_ADMINS", default='mybullet Admin <admin@example.com>')])
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'mybullet.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "mybullet.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/mybullet"),
}
